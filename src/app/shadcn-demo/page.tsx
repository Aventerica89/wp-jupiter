                ...
                <Card>
                  ...
                  <CardContent>
                    {loading ? (
                      ...
                      <div className="text-2xl font-bold text-blue-600">{stats.pluginUpdates}</div>
                    )}
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    {loading ? (
                      ...
                      <div className="text-2xl font-bold text-purple-600">{stats.themeUpdates}</div>
                    )}
                  </CardContent>
                </Card>
              </div>

              {/* Sites Table - Your Real Sites */}
              <Card>
                <CardHeader>
